	...
	<div class="container">
		...
		<div class="border rounded">
			<div style="background-color: rgb(237, 240, 243);">
				<h6 class="pt-3 ml-3 ">Danh sách bài đăng bị từ chối</h6>
				<hr>
			</div>
			<div class="container">
					...
					<div class="text-right">
						...
						<c:forEach begin="1" end="${totalPages}" var="i">
							<c:choose>
								<c:when test="${currentPage != i}">
									<a href="${contextPath}/list-user-post-hidden/page/${i}">[${i}]</a>&nbsp;
								</c:when>
								<c:otherwise>
									<span>[${i}]</span>&nbsp;
								</c:otherwise>
						...
						<c:choose>
							<c:when test="${currentPage < totalPages}">
								<a
									href="${contextPath}/list-user-post-hidden/page/${currentPage+1}"><i
						...
						<c:choose>
							<c:when test="${currentPage < totalPages}">
								<a
									href="${contextPath}/list-user-post-hidden/page/${totalPages}">Last</a>&nbsp;
							</c:when>
						</c:choose>
					</div>
				</c:if>
